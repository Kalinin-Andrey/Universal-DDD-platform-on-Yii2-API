...
/**
 * This is the model class for table "timestamp_property_value".
 *
 * @property integer $id
 ...
 */
class TimestampPropertyValueRecord extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'timestamp_property_value';
    }

...
/**
 * This is the model class for table "bigint_property_value".
 *
 * @property integer $id
 ...
 */
class BigintPropertyValueRecord extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */

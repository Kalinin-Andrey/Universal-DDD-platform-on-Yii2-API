...
var transformCanvas = function transformCanvas(canvas) {
	...
	if (crop) {
		...
		//console.log('limit:', crop.x, crop.y, crop.width, crop.height);

		//console.log('percentages: ',px, py, pw, ph);
			...
			value: function _confirm() {
				...
				this._element.dispatchEvent(new CustomEvent('confirm', {
					detail: {
						...
						crop: scaleRect(this._cropper.area, isTilted ? this._input.height : this._input.width, isTilted ? this._input.width : this._input.height)
					}
				}));
			}
		}, {
...
var Slim = function () {
   ...
   */
		...
		value: function _save() {
			...
			// get and store meta data values
			if (!data.meta) {
				data.meta = {};
			}
			var dataAttributes = this._element.dataset;
			for (var key in dataAttributes) {
				if (key.indexOf('meta') !== 0) {
					continue;
				}
				data.meta[lowercaseFirstLetter(key.substr(4))] = dataAttributes[key];
			}
